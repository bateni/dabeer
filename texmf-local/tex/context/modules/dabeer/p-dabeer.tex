...
\definefontfamily [farsifont] [math] [safarsimath]
...
\defineconversion[ا][\arabicnumerals]

%D Fixed direction of columns and columnized items to be RTL.
%% Wolfgang says there is a way to directly set the following
%% within startitemize but I could not figure it out.
