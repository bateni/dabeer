...
%% This is a hacky way to fix the comma issue, partly.
%% The comma after ``see also'' is still there.
...
\setupregister[index]
              [n=2,
                pagecolor=blue,
                compress=yes,
%% fixes bad shaping of ``see also'' and 
%%       the direction for English entries.
                pagestyle=\zwnj,
