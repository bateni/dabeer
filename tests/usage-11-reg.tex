...
\setupregister[index][1][textcolor=darkred]
\setupregister[index][2][textcolor=darkgreen,textstyle=bold]
...
به این شرح است.  برخی از اینان در شرایط فعلی حل‌شده‌اند،
و برخی کماکان نیازمند توجه و گه‌گاه ایجاد تغییراتی فراتر
از تغییرات محلی می‌باشند.
...
\item
حروف اصلی نظیر ك و ي بایستی کاملاً مانند حروف مشابه فارسی‌شان عمل کنند.
٪٪ یعنی چه؟
\item
...
\item
توضیحات اضافه نظیر \quotation{رجوع شود} با رعایت شکل‌دهی حروف فارسی حروفچینی شود.
\item
...
\index{ذرت}
از‌آن‌جایی‌که صفحات خالی در ایجاد نمایه باعث دردسر می‌گردند،
دراین‌جا متنی کوتاه قرار داده‌ایم.
\page
\index{سلام}
\index{گوگل}
\index{اب}
